...
export const PRODUCTS: Product[] = [
  ...
  { slug: 'ivan-chai-mint', name: 'Иван-чай с мятой', sub: 'С добавлением мяты · 80 г', price: '360 ₽', category: 'Рассыпной', image: IMAGES[3] },
  { slug: 'ivan-chai-raspberry', name: 'Иван-чай с малиной', sub: 'С добавлением малины · 80 г', price: '390 ₽', category: 'Рассыпной', image: IMAGES[0] },
  { slug: 'ivan-chai-lemon', name: 'Иван-чай с лимоном', sub: 'С добавлением лимона · 80 г', price: '370 ₽', category: 'Рассыпной', image: IMAGES[1] },
  { slug: 'ivan-chai-bulk-200', name: 'Иван-чай рассыпной', sub: 'Развесной · 200 г', price: '790 ₽', category: 'Развес', image: IMAGES[2] },
  { slug: 'ivan-chai-bulk-500', name: 'Иван-чай рассыпной', sub: 'Развесной · 500 г', price: '1 800 ₽', category: 'Развес', image: IMAGES[3] },
  { slug: 'ivan-chai-gift', name: 'Подарочный набор', sub: 'Набор · 3 × 50 г', price: '890 ₽', category: 'Набор', image: IMAGES[2] },
]
